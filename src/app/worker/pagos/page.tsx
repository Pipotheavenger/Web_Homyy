...
export default function PagosWorker() {
  ...
  const balance = 2850000; // $2,850,000 COP
  ...
  const handleConfirmarPago = () => {
    ...
    console.log('Pago confirmado por el trabajador');
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 bg-gradient-to-br from-orange-50/30 via-red-50/30 to-yellow-50/30 min-h-screen">
        {/* Balance Card */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_rgba(249,115,22,0.08)] border border-white/30 p-6 mb-6">
        ...
        {/* Transaction History */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_rgba(249,115,22,0.08)] border border-white/30 p-6">
      ...
      {(showRecargar || showRetirar) && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-md rounded-2xl max-w-md w-full shadow-[0_20px_60px_rgba(249,115,22,0.15)] border border-white/40">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-100 to-red-100 rounded-xl flex items-center justify-center shadow-lg">
                    {showRecargar ? <TrendingUp size={24} className="text-orange-500" /> : <TrendingDown size={24} className="text-orange-500" />}
                  </div>
                  <div>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white/80 backdrop-blur-sm"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-red-600 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
