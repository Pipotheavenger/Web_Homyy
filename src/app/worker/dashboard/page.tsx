  ...
  return (
    <Layout title="Dashboard" currentPage="dashboard">
      <div className="p-6">
        ...
        <div className={`bg-gradient-to-r from-emerald-300 to-emerald-400 rounded-2xl mb-6 text-gray-800 relative overflow-hidden h-48 md:h-56 lg:h-64`}>
          <div className="flex flex-col md:flex-row items-center justify-between p-6 md:p-8 lg:p-10 h-full relative z-10">
            <div className="flex-1 mb-6 md:mb-0">
              ...
              <p className="text-gray-700 mb-4 text-sm md:text-base lg:text-lg">¿Listo para encontrar tu próximo trabajo?</p>
              <button 
                onClick={handleVerTrabajos}
                className="bg-white text-emerald-600 px-4 md:px-6 py-2 md:py-3 rounded-xl font-medium hover:bg-emerald-50 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2 text-sm md:text-base"
              >
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-sm border p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={handleVerTrabajos}
                  className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-lg hover:opacity-90 transition-all text-sm font-medium flex items-center space-x-2"
                >
                  <Plus size={16} />
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-xs text-gray-500">
                            ...
                            {app.proposed_price && (
                              <div className="flex items-center space-x-1">
                                <DollarSign size={12} />
                                <span className="font-semibold text-emerald-600">{formatPrice(app.proposed_price)}</span>
                              </div>
                            )}
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {(app.status === 'withdrawn' || app.service?.status === 'completed') ? (
                            <button
                              ...
                              className="px-3 py-1 bg-red-100 text-red-700 hover:bg-red-200 transition-colors flex items-center space-x-1 rounded-lg"
                            ...
                            <>
                              {app.service?.id && (
                                <button
                                  ...
                                  className="px-3 py-1 bg-emerald-100 text-emerald-700 hover:bg-emerald-200 transition-colors flex items-center space-x-1 rounded-lg"
                              ...
                              {app.status === 'accepted' && (
                                <button
                                  ...
                                  className="px-3 py-1 bg-gradient-to-r from-emerald-500 to-green-500 text-white hover:from-emerald-600 hover:to-green-600 transition-all flex items-center space-x-1 rounded-lg transform hover:scale-105"
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2 text-sm text-gray-600">
                        <span className="font-bold text-lg">{stat.valor}</span>
                                                 <span className="text-emerald-600 font-medium">{stat.cambio}</span>
                      </div>
                    </div>
                  </div>
                ))}
