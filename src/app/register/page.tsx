        ...
        if (verifiedPhone) {
          return (
            <PhoneVerifyForm
              ...
              onBack={() => setVerifiedPhone(null)}
              onVerified={() => setCurrentStep('personal-data')}
            />
          );
        }
        return (
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl border border-white/30 shadow-2xl p-4 sm:p-8 space-y-6">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-purple-800 transition-all duration-200 shadow-lg shadow-purple-600/25"
                >
                  Enviar código
                </button>
              </div>
